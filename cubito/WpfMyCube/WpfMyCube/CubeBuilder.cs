...
namespace WpfMyCube
{
    ...
    public class CubeBuilder : ModelBuilder
    {
        ...
        public ModelVisual3D Create(int x, int y, int z)
        {
            ...
            Point3D p2 = new Point3D(a + x, 0 + y, a + z);
            Point3D p3 = new Point3D(0 + x, 0 + y, a + z);
            Point3D p4 = new Point3D(0 + x, a + y, 0 + z);
            Point3D p5 = new Point3D(a + x, a + y, 0 + z);
            Point3D p6 = new Point3D(a + x, a + y, a + z);
            Point3D p7 = new Point3D(0 + x, a + y, a + z);
            Point3D p8 = new Point3D(0 + x, a + y, a + z);
